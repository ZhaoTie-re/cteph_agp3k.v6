# tuning.rv — run summary (narrow_mainland)
...
| Rare call set | `/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v6/wgs.auto.par/results/12_model_inputs/narrow_mainland/genotype/fixed_model/cteph_agp3k_v6_wgs_merged.sample_qc.variant_qc.popgmm.fixed_model.maf_lt_threshold` |
| Info file | `/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v6/info/cteph_agp3k.v6.20260507.xlsx` |
| Ancestry PC (+PC model) | `/LARGE0/gr10478/b37974/Pulmonary_Hypertension/cteph_agp3k.v6/wgs.auto.par/results/12_model_inputs/narrow_mainland/covariates/bbj_mainland_pc.sex.tsv` (bbj_mainland, 10 PCs) |
| minAC sweep | 0-20 |
| OLS SE | classical |
...
| Variants excluded (depth-diff) | 1352762 |
| Samples retained | 2165 |
| Variants retained (minAC 0) | 14750581 |
| Depth-diff knee | 0.03 (retained 91.5995%) |
...
| beta_group @ rec (noPC) | -0.00758899  (p = 0.320078) |
| Variants kept @ rec | 6857863 |
