...
**Figure file:** `cohort_compare.fixed.allele.png`
...
| log-OR correlation narrow_mainland vs intermediate_mainland | 0.985 |
| log-OR correlation narrow_mainland vs full_mainland | 0.9582 |
| log-OR correlation intermediate_mainland vs full_mainland | 0.9727 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| HLA_F*01 | F |  | narrow_mainland | fixed | 2.906 | 1.663 | 5.078 | 1.067 | 0.2847 | 1.787e-04 | 0.006458 | 2,168 | 1 | 3 | 3 | 1 |
| HLA_F*01 | F |  | intermediate_mainland | fixed | 3.069 | 1.774 | 5.308 | 1.121 | 0.2796 | 6.066e-05 | 0.005645 | 2,480 | 1 | 3 | 3 | 1 |
| HLA_F*01 | F |  | full_mainland | fixed | 3.002 | 1.782 | 5.055 | 1.099 | 0.266 | 3.583e-05 | 0.004884 | 3,071 | 1 | 3 | 3 | 1 |
| HLA_B*40:02 | B |  | narrow_mainland | fixed | 1.701 | 1.279 | 2.263 | 0.5313 | 0.1457 | 2.654e-04 | 0.05835 | 2,168 | 1 | 1 | 3 | 0 |
| HLA_B*40:02 | B |  | intermediate_mainland | fixed | 1.55 | 1.187 | 2.024 | 0.4382 | 0.1363 | 0.0013 | 0.06149 | 2,480 | 0 | 1 | 3 | 0 |
| HLA_B*40:02 | B |  | full_mainland | fixed | 1.446 | 1.117 | 1.871 | 0.3685 | 0.1315 | 0.005069 | 0.06529 | 3,071 | 0 | 1 | 3 | 0 |
...
- It covers the allele class under the fixed model only. The other marker class and the other model are separate analyses with their own figures and their own multiple-testing burdens.
