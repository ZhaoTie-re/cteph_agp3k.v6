...
**Figure file:** `cohort_compare.fixed.residue.png`
...
| log-OR correlation narrow_mainland vs intermediate_mainland | 0.97 |
| log-OR correlation narrow_mainland vs full_mainland | 0.8979 |
| log-OR correlation intermediate_mainland vs full_mainland | 0.9615 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| AA_A_178_T | A | A:178 | full_mainland | fixed | 0.04557 | 0.01596 | 0.1301 | -3.088 | 0.5354 | 7.975e-09 | 0.9967 | 3,067 | 1 | 1 | 1 | 1 |
| AA_DQB1_57_V | DQB1 | DQB1:57 | narrow_mainland | fixed | 0.5906 | 0.4603 | 0.7577 | -0.5267 | 0.1272 | 3.446e-05 | 0.1548 | 2,168 | 1 | 1 | 3 | 0 |
| AA_DQB1_57_V | DQB1 | DQB1:57 | intermediate_mainland | fixed | 0.6256 | 0.4912 | 0.7968 | -0.469 | 0.1234 | 1.442e-04 | 0.1492 | 2,480 | 0 | 1 | 3 | 0 |
| AA_DQB1_57_V | DQB1 | DQB1:57 | full_mainland | fixed | 0.6267 | 0.495 | 0.7936 | -0.4672 | 0.1204 | 1.044e-04 | 0.1457 | 3,071 | 0 | 1 | 3 | 0 |
...
- It covers the residue class under the fixed model only. The other marker class and the other model are separate analyses with their own figures and their own multiple-testing burdens.
