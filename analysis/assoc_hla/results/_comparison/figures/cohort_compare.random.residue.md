...
| markers significant in at least one cohort | 2 |
| markers significant in every cohort | 0 |
| markers drawn in the forest | 2 |
| significant, narrow_mainland | 1 |
| significant, intermediate_mainland | 0 |
| significant, full_mainland | 1 |
| significant only in narrow_mainland | 1 |
| significant only in intermediate_mainland | 0 |
| significant only in full_mainland | 1 |
| log-OR correlation narrow_mainland vs intermediate_mainland | 0.9746 |
| log-OR correlation narrow_mainland vs full_mainland | 0.9019 |
| log-OR correlation intermediate_mainland vs full_mainland | 0.9569 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| AA_A_178_T | A | A:178 | full_mainland | random | 0.04845 | 0.01724 | 0.1361 | -3.027 | 0.5271 | 4.627e-09 | 0.9968 | 3,097 | 1 | 1 | 1 | 1 |
| AA_DQB1_57_V | DQB1 | DQB1:57 | narrow_mainland | random | 0.5899 | 0.4524 | 0.7692 | -0.5278 | 0.1354 | 4.866e-05 | 0.1556 | 2,195 | 1 | 1 | 3 | 0 |
| AA_DQB1_57_V | DQB1 | DQB1:57 | intermediate_mainland | random | 0.6249 | 0.4821 | 0.8099 | -0.4702 | 0.1323 | 1.902e-04 | 0.1499 | 2,508 | 0 | 1 | 3 | 0 |
| AA_DQB1_57_V | DQB1 | DQB1:57 | full_mainland | random | 0.6275 | 0.4857 | 0.8106 | -0.466 | 0.1307 | 1.808e-04 | 0.1462 | 3,101 | 0 | 1 | 3 | 0 |
...
- It covers the residue class under the random model only. The other marker class and the other model are separate analyses with their own figures and their own multiple-testing burdens.
