# HLA allele hits against jMorp 61KJPN-HLA — narrow_mainland / fixed

**Figure file:** `freq_qc.fixed.png`
...
| alleles with a usable fit and a QC row | 152 |
| fits excluded on ERRCODE | 0 |
| alleles in the sumstats file | 152 |
| allele rows in marker_qc.tsv | 2,175 |
| alleles with a reference frequency | 129 |
| alleles the reference has never observed | 23 |
| significance threshold | 4.587e-04 |
| threshold source | given with --alpha |
| significant alleles | 2 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| HLA_F*01 | F | 0.006378 | — | 0 | 28 | 0.006378 | 1 | 2.906 | 1.663 | 5.078 | 1.787e-04 |
| HLA_B*40:02 | B | 0.05809 | 0.09596 | 1 | 255 | 0.05809 | 1 | 1.701 | 1.279 | 2.263 | 2.654e-04 |
