# HLA allele hits against jMorp 61KJPN-HLA — full_mainland / fixed
...
| alleles with a usable fit and a QC row | 170 |
| fits excluded on ERRCODE | 0 |
| alleles in the sumstats file | 170 |
| allele rows in marker_qc.tsv | 2,175 |
| alleles with a reference frequency | 146 |
| alleles the reference has never observed | 24 |
| significance threshold | 4.065e-04 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| HLA_F*01 | F | 0.004837 | — | 0 | 30 | 0.004837 | 1 | 3.002 | 1.782 | 5.055 | 3.583e-05 |
