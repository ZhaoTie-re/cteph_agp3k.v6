...
OUT_COLS = ['cohort', 'peak_id', 'cs', 'cs_size', 'cs_coverage', 'cs_purity_min_abs_corr',
            'variant_id', 'rsID', 'rsID_unresolved', 'Gene', 'Gene_Biotype', 'chrom', 'pos', 'EA', 'OA',
...
def main():
    ...
    for _, r in members.iterrows():
        ...
        row = {
            ...
            'variant_id': vid, 'rsID': VA._rsid_of(rsids, vid),
            'rsID_unresolved': VA._rsid_unresolved(rsids, vid),
