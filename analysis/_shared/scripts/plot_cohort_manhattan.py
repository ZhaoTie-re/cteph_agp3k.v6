...
def parse_args():
    p = argparse.ArgumentParser(description='Every cohort\'s scan of one model, on one genomic axis.')
...
def main():
    ...
    figure_doc.write_doc(
        ...
        panels=[('abcdefgh'[i],
                 ...
                 f'LEFT — every analysed variant of the {c} {args.model} scan at its genomic position, '
