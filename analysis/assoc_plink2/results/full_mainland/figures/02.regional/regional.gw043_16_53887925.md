# Regional association — full_mainland, peak gw043_16_53887925

**Figure file:** `regional.gw043_16_53887925.png`
...
| window | chr16:53,633,096-54,140,373 |
| variants in window | 1,125 |
| genes drawn | 2 |
| cohort: r2 measured | 1,125 |
| cohort: bounded r2 < 0.2 | 0 |
| cohort: not in panel | 0 |
| tommo: r2 measured | 59 |
| tommo: bounded r2 < 0.2 | 1,066 |
| tommo: not in panel | 0 |
| 1000g_eas: r2 measured | 1,109 |
| 1000g_eas: bounded r2 < 0.2 | 0 |
| 1000g_eas: not in panel | 16 |
