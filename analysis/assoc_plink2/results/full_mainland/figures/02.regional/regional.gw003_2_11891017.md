# Regional association — full_mainland, peak gw003_2_11891017

**Figure file:** `regional.gw003_2_11891017.png`
...
| window | chr2:11,624,908-12,305,379 |
| variants in window | 1,581 |
| genes drawn | 8 |
| cohort: r2 measured | 1,581 |
| cohort: bounded r2 < 0.2 | 0 |
| cohort: not in panel | 0 |
| tommo: r2 measured | 55 |
| tommo: bounded r2 < 0.2 | 1,526 |
| tommo: not in panel | 0 |
| 1000g_eas: r2 measured | 1,547 |
| 1000g_eas: bounded r2 < 0.2 | 0 |
| 1000g_eas: not in panel | 34 |
