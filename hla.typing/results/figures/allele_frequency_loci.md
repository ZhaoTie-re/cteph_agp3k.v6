# HLA allele frequencies against jMorp 61KJPN-HLA, locus by locus

**Figure file:** `allele_frequency_loci.png`

## The question this figure answers

At which locus, and at which allele, do the observed frequencies and the reference disagree?
...
- Each panel is scaled to its own locus, so panel-to-panel comparison by eye is not meaningful. Use the concordance panel for that.
- A locus with few observed alleles has a short axis and looks tidier than a locus with many; tidiness here is allele diversity, not typing quality.
